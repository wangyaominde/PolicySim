    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <motion.div
              className="w-full max-w-md bg-surface-container/80 backdrop-blur-xl border border-primary/10 rounded-xl p-6"
            ...
            >
              <h2 className="text-on-surface font-headline font-semibold text-lg mb-1">
                API Settings
              </h2>
